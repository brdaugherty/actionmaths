...
*   Press the **Spacebar** or **tap the board** to drop a ball. Hold it down for a stream.
...
*   Click **Toggle Continuous Stream** to watch the classical interference pattern organically build up.
...
*   Hit **Spacebar** to fire expanding probability waves.
